...
rectangle_1_length = float(
    input("Please give me a length of a side of Rectangle 1:"))
rectangle_1_width = float(
    input("Please give me a width of a side of Rectangle 1:"))
